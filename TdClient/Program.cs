...
namespace TdLib
{
    ...
    {
        private const int ApiId = 29507894;
        private const string ApiHash = "003cb70923156975558c4ddd14423c65";
        
        private const string MyPhoneNumber = "+79621337887";
        ...
        private static async Task Main()
        {
            ...
            var contacts = await _client.ImportContactsAsync(new[] { new Contact { PhoneNumber = phoneNumber } });
            var chat = await _client.CreatePrivateChatAsync(contacts.UserIds[0]);
            

            if (contacts.ImporterCount.Length > 0)
                await _client.SendMessageAsync(chat.Id,
